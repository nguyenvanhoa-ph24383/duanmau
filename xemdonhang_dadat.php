                            ...
                            ?>
                                <div class='info-product__table-container'>
                                    ...
                                    <div class='info-product__container-bottom'>
                                        ...
                                        <span class='info-product__container-new'><?= $detail['dongia'] ?> 000.000 VNĐ</span>
                                    </div>
                                </div>
                            <?php endforeach; ?>

                            <div class='info-product__table-footer'>
                                <p class='info-product__footer-top'>Thành Tiền : <span class='info-product__footer-top-money'><?= $order['total'] ?> 000.000 VNĐ</span></p>
